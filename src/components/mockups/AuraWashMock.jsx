...
const orders = [
  ...
  { id: '#AW-2042', customer: 'J. Cruz',    branch: 'Pasig',  status: 'Ready',     ago: '9m',  tone: 'bg-accent/10 text-accent border-accent/25' },
            ...
            <span
              ...
              className={`shrink-0 px-3 py-1 rounded-full border font-mono text-[0.62rem] ${
                i === 0
                  ...
                  : 'bg-white/[0.02] text-faint border-line'
              }`}
            >
              {b}
            </span>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {kpis.map((k) => (
            <div key={k.label} className="mock-tile">
              ...
              <div className={`font-display text-xl mt-1.5 ${k.tone}`}>{k.value}</div>
        ...
        <div className="mock-row">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-8 h-8 rounded-lg bg-accent/10 border border-accent/25 flex items-center justify-center shrink-0">
              <span className="font-mono text-[0.6rem] text-accent">D3</span>
            </div>
            <div className="min-w-0">
